    ...
    <section id="leadership" className="py-32 md:py-44 border-t border-border/30">
      <div className="container max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <motion.div 
            {...fadeUp(0.1)}
            className="relative aspect-[4/5] w-full max-w-md mx-auto lg:mx-0 lg:ml-auto rounded-3xl overflow-hidden bg-foreground/5 border border-foreground/10"
          >
            ...
            <div className="absolute inset-0 -z-10 flex flex-col items-center justify-center opacity-20">
              <div className="w-32 h-32 rounded-full border border-foreground/20 border-dashed animate-[spin_20s_linear_infinite]" />
              <div className="absolute w-16 h-16 rounded-full border border-foreground/30 border-dashed animate-[spin_10s_linear_infinite_reverse]" />
            </div>
            
            <div className="absolute bottom-8 left-8 right-8 z-20">
              <div className="text-[10px] font-bold tracking-widest text-foreground/60 uppercase mb-2">Executive Leadership</div>
              <h3 className="text-2xl font-medium text-foreground">Dr. Olakunle Rufus Oladosu</h3>
              <p className="text-foreground/70 text-sm mt-1">Acting Director, CSLS</p>
            </div>
          </motion.div>
          ...
          <div className="flex flex-col justify-center">
            ...
            <motion.div {...fadeUp(0.3)} className="space-y-8">
              <div className="group relative pl-6 border-l border-foreground/10 hover:border-foreground/40 transition-colors">
                <div className="absolute w-2 h-2 bg-foreground/20 rounded-full -left-[4.5px] top-1.5 group-hover:bg-white transition-colors" />

...
import { Linkedin, ExternalLink, Menu, X } from "lucide-react";
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 md:px-12 backdrop-blur-md bg-background/20 border-b border-border/10">
      ...
      <div className="flex items-center gap-3">
        ...
        <a href="#" aria-label="External Link" className={cn("hidden sm:flex liquid-glass w-10 h-10 rounded-full items-center justify-center text-foreground hover:bg-white/5 transition-colors")}>
          <ExternalLink className="w-4 h-4" />
        </a>

        {/* Mobile Menu Toggle Button */}
        <button
          className="md:hidden liquid-glass w-10 h-10 rounded-full flex items-center justify-center text-foreground hover:bg-white/5 transition-colors ml-1"
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 right-0 bg-background/95 backdrop-blur-xl border-b border-border/10 md:hidden overflow-hidden shadow-2xl"
          >
            <div className="flex flex-col px-6 py-4 gap-4">
              ...
              <div className="flex items-center gap-4 pt-4 pb-2 sm:hidden">
                ...
                <a href="#" aria-label="External Link" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-white/10 transition-colors">
                  <ExternalLink className="w-4 h-4" />
                </a>
              </div>
            </div>
